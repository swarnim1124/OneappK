...
class GetSubmissionComplianceReportUseCase @Inject constructor(
    private val repository: AttendanceRepository
) {
    suspend operator fun invoke(): List<AttendanceSession> = repository.getSubmissionComplianceReport()
}
