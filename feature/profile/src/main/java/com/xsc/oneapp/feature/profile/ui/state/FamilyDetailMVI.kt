...
sealed class FamilyDetailState {
    ...
    data class NetworkError(val message: String, val appError: AppError? = null) : FamilyDetailState()
    data class UnexpectedError(val message: String, val appError: AppError? = null) : FamilyDetailState()
}
...
sealed class FamilyDetailEvent {
    ...
    data class AddFamilyDetail(val fields: Map<String, Any>) : FamilyDetailEvent()
